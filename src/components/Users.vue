          ...
          <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-5">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                ...
                <button @click="toggleModal(user.id)" data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="px-3 py-2 text-xs font-medium text-center rounded-lg text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800" type="button">
Delete
</button>
  ...
  <div class="bg-white rounded-lg shadow-md p-4 max-w-md">
        <div class="relative  dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <button @click="deleteForm(selectedUserId)" data-modal-hide="popup-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                    Yes, I'm sure
                </button>
  ...
  deleteForm() {
    ...
    axios.delete(`http://68.183.69.211:5025/api/User?ids=${this.selectedUserId}`, {
      headers: {
        Authorization: 'Bearer ' + this.token
      }
    })
