         ...
         <li>
            <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
               <i class="fa-solid fa-store"></i>
                  <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Vendors</span>
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                  <li>
                     <router-link to="/vendors" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Vendors </router-link>
                  </li>
                  <li>
                     <a href="/contacts" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Contacts</a>
                  </li>
                  <li>
